...
title: Status
description: >-
  Use the `status` command to preview changes between your local files and the remote LeadCMS instance.  Learn how to interpret the output, filter by ID or slug and prepare for a clean push.
coverImageUrl: ''
coverImageAlt: ''
