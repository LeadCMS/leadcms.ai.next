...
updatedAt: '2025-11-08T11:29:22.31576Z'
title: Documentation
description: >-
...
<FeatureGrid columns={2}>
  <FeatureCard title="Getting Started" description="Complete setup guide with step-by-step instructions to deploy and configure LeadCMS" href="/docs/getting-started/installation/" />

  <FeatureCard title="Plugins" description="Extend functionality with built-in and custom C# plugins using our modular architecture" href="/docs/getting-started/plugins/" />
</FeatureGrid>
