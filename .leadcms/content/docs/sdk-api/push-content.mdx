...
title: Push Content
description: >-
  Learn how to push your local MDX/JSON files back to LeadCMS.  This article explains how the SDK detects changes, handles content types, resolves conflicts and updates your local metadata after a successful push.
coverImageUrl: ''
coverImageAlt: ''
