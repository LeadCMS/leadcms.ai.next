...
updatedAt: '2026-03-05T11:58:33.557626Z'
title: Status Command
description: >-
  Preview changes between local files and remote LeadCMS. Interpret output,
  filter results and prepare for a clean push.
coverImageUrl: ''
coverImageAlt: ''
...
- **Use scoped status for clarity.**  For detailed content diffs, prefer `status-content --preview`.
...
<FeatureGrid columns={2}>
  ...
  <FeatureCard
    ...
    description="Check and push template changes with scoped status"
    href="/docs/sdk-api/email-templates/"
  />
  <FeatureCard
    title="Settings Sync"
    description="Use status-settings for tracked configuration"
    href="/docs/sdk-api/settings-sync/"
  />
  <FeatureCard
    title="Media Sync"
    description="Inspect media differences with status-media"
