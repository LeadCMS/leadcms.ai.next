...
title: Contact Forms
description: >-
  Implement contact forms that feed directly into LeadCMS’s built‑in CRM.
  Learn how the Site plugin processes submissions, creates leads, and sends automated emails, and discover how to customise the built‑in templates or extend the workflow with your own plugin.
coverImageUrl: ''
coverImageAlt: ''
...
The standard Site plugin covers most contact form scenarios. However, if you need custom logic – such as saving submissions to an external system, sending Slack notifications or adding bespoke validation – you can develop your own plugin. Custom plugins can expose their own API endpoints, process form data in any way and send emails through custom templates. See the **Plugins** section for guidance on building and registering a new plugin.
