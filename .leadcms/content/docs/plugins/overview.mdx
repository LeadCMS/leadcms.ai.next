...
updatedAt: '2026-03-23T06:44:50.674332Z'
...
<FeatureGrid columns={2}>
  <FeatureCard title="🤖 AI Plugin" description="OpenAI integration for content generation, translation, and image creation with GPT models and DALL-E" href="/docs/plugins/ai/" />

  <FeatureCard title="📱 SMS Plugin" description="Multi-gateway SMS delivery with country-specific routing through Amazon SNS, SMSC, Twilio, and more" href="/docs/plugins/sms/" />

  <FeatureCard title="📧 SendGrid Plugin" description="High-volume email delivery with real-time tracking, analytics, and webhook processing" href="/docs/plugins/sendgrid/" />

  <FeatureCard title="📬 Email Sync Plugin" description="IMAP email synchronization for lead management and communication tracking" href="/docs/plugins/email-sync/" />

  <FeatureCard title="🌐 Site Plugin" description="Website functionality with contact forms, newsletter subscriptions, and lead capture" href="/docs/plugins/site/" />

  <FeatureCard title="🔄 Reverse Proxy Plugin" description="Request routing and forwarding for external services like Elasticsearch and Kibana" href="/docs/plugins/reverse-proxy/" />
</FeatureGrid>
...
<FeatureGrid columns={2}>
  <FeatureCard title="Deploying" description="Learn how to deploy LeadCMS with your custom plugins to production" href="/docs/ops/deploying/" />
</FeatureGrid>
