...
title: Static Export
description: >-
  Learn how to build and deploy a fully static site with LeadCMS using static site generation.
  This guide covers exporting your site with Next.js, handling 404 pages and trailing slashes, and choosing a hosting provider.
coverImageUrl: ''
coverImageAlt: ''
