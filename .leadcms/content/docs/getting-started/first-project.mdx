...
updatedAt: '2026-03-23T06:44:47.886541Z'
title: First Project
description: >-
  Get started with your first LeadCMS site using Next.js. Clone, run locally,
  initialize SDK, push content and connect to your CMS instance.
coverImageUrl: ''
coverImageAlt: ''
...
<Steps>
  <Step title="Preview the changes">
    ...
    ```bash
    pnpm exec leadcms status-content --preview
    ```
