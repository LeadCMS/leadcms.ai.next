...
export const ContactHero: React.FC<ContactHeroProps> = ({ badge = "Support", title, description }) => (
  <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-background to-muted">
    <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        <Badge className="mb-4" variant="outline">
            ...
            {partnershipSection && (
              <div className="mt-10" id="partnership">
                ...
                <div className="flex items-center">
                  ...
                  <span>Email us at <strong>{partnershipSection.email}</strong></span>
                </div>
              </div>
            )}
          </div>
      ...
      <div className="flex items-start mb-6">
        ...
        <div>
          ...
          <address className="not-italic text-muted-foreground">
            {address.street}<br />
            {address.city} {address.state}{address.zip && ` ${address.zip}`}<br />
            {address.country}
          </address>
        </div>
      </div>
...
export const SocialLinks: React.FC<SocialLinksProps> = ({ 
  ...
  <div>
    ...
    <div className="bg-background rounded-xl p-8 shadow-sm border">
      ...
      <div className={`grid gap-4 ${links.length === 1 ? 'grid-cols-1 max-w-xs' : links.length === 2 ? 'grid-cols-2' : 'grid-cols-2'}`}>
...
export const ContactLocationAndSocial: React.FC<ContactLocationAndSocialProps> = ({ office, social }) => (
