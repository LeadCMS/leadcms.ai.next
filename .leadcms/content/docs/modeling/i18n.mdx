...
description: >-
  Implement multilingual support in your LeadCMS projects. Learn how to configure languages, organise content by locale, use the SDK to fetch translations and routes, and leverage the Admin UI for translating content with AI assistance.
coverImageUrl: ''
coverImageAlt: ''
