...
updatedAt: '2025-11-10T17:43:52.540299Z'
title: "Pull\_Content"
description: >-
...
The `pull` commands retrieve **published** content by default.  To include draft items you must enable draft support (`LEADCMS_ENABLE_DRAFTS=true`) and provide an API key.  See the [Draft Preview](/docs/preview/draft-preview/) and [i18n](/docs/modeling/i18n/) guides for more information on how drafts are organised and served.
</Callout>
