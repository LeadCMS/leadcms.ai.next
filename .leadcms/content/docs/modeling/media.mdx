...
updatedAt: '2026-03-23T06:50:09.302116Z'
title: Media Management
description: >-
  Manage images and assets in LeadCMS. Learn uploads, media organization, CMS to
  site path mapping, and file optimization for fast pages.
coverImageUrl: ''
coverImageAlt: ''
...
If you edit the image inside the Admin UI, the SDK will update the file accordingly when you run the pull command again.
