...
<Callout type="info" title="Docker Compose Focus">
  This guide is specifically for Docker Compose deployments as covered in our [deployment guide](/docs/ops/deploying). For production environments with managed services, adapt these procedures to your infrastructure.
</Callout>
...
We recommend using the automated backup scripts covered in detail in our [Backups and Recovery guide](/docs/ops/backups).
