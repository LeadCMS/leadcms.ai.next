...
title: Content Types
description: >-
  Learn how to define and manage content types in LeadCMS.
  Understand the built‑in defaults, design best practices and how to create new types via the CLI or the Admin UI.
coverImageUrl: ''
coverImageAlt: ''
