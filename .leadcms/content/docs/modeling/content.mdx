...
title: Content
description: >-
  Understand how LeadCMS stores and synchronises your content.
  Learn about standard and custom metadata, how the SDK maps fields between local files and the CMS, and best practices for modelling MDX and JSON content.
coverImageUrl: ''
coverImageAlt: ''
