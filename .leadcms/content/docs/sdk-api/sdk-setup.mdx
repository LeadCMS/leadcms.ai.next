...
title: SDK Setup
description: >-
  Configure your project to use the LeadCMS SDK and CLI. Learn how to install the package, set up environment variables, run the interactive init wizard, authenticate for write access and pull your initial content.
coverImageUrl: ''
coverImageAlt: ''
