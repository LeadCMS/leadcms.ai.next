...
updatedAt: '2025-11-10T17:43:52.328981Z'
title: Installation Guide
description: >-
  Install and run LeadCMS using Docker Compose. This guide covers basic system
  requirements, environment configuration and how to get your instance up and
  running locally.
coverImageUrl: ''
coverImageAlt: ''
...
The provided Docker Compose configuration is intended for development, evaluation and local use. For production deployments, see the [Static Export](/docs/deploy/static-export/) and [Deploying](/docs/ops/deploying/) documentation for guidance on using managed databases, setting up SSL, backups, monitoring, and high‑availability architectures.
</Callout>
...
<FeatureGrid columns={2}>
  ...
  <FeatureCard
    title="SDK Setup"
    description="Learn how to integrate LeadCMS SDK with your frontend"
